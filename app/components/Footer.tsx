export default function Footer() {
  return (
    <footer className="mt-20 text-center text-zinc-400 text-sm border-t border-zinc-200 dark:border-zinc-800 pt-8 pb-8">
      <p className="mb-2">© {new Date().getFullYear()} English Vocabulary Booster.</p>
      ...
      <div className="flex justify-center gap-6">
        ...
        <a 
          href="https://saweria.co/hafizamrullah"
          target="_blank"
          rel="noopener noreferrer"
          className="text-zinc-400 hover:text-yellow-500 dark:hover:text-yellow-400 transition-all duration-300 hover:scale-110"
          aria-label="Saweria"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
